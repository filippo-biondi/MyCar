var loadOnGPU = function(gl, jsonMesh) {
  ...
  gl.bindBuffer( gl.ARRAY_BUFFER, gpuMesh.normalBuffer);
   ...
   if(jsonMesh.vertices[2] != undefined) {
       gpuMesh.texCoordBuffer = gl.createBuffer();
       gl.bindBuffer(gl.ARRAY_BUFFER, gpuMesh.texCoordBuffer);
       gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(jsonMesh.vertices[2].values), gl.STATIC_DRAW);
   }
